/**
 *  This function initalizes the Compass Chart for wind direction and speed
 */
function initWindCompassChart(containerId) {
    if (typeof (window.windCompassChart) != "undefined") {
        window.windCompassChart.destroy();
    }

    window.windCompassChart = new Highcharts.Chart({
        ...
        yAxis: [{
            ...
            title: {
                ...
                y: +10,
                text: '<div id="windCompassTitle"> test </div>'
            },
            labels: {
                style: {
                    color: '#fff',

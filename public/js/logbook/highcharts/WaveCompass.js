/**
 *  This function initalizes the Compass Chart for wave direction and height
 */
function initWaveCompassChart(containerId) {
    if (typeof (window.waveCompassChart) != "undefined") {
        window.waveCompassChart.destroy();
    }

    window.waveCompassChart = new Highcharts.Chart({
        ...
        yAxis: [{
            ...
            title: {
                ...
                y: +10,
                text: '<div id="waveCompassTitle"> test </div>'
            },
            labels: {
                style: {
                    color: '#fff',

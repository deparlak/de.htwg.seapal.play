...
curl -s -X DELETE http://$USERNAME:$PASSWORD@$HOST/seapal_settings_db/
...
curl -s -X PUT http://$USERNAME:$PASSWORD@$HOST/seapal_settings_db/
...
curl -s -X PUT http://$USERNAME:$PASSWORD@$HOST/seapal_settings_db/_design/Settings -d @settings.json

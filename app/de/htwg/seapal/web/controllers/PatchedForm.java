...
public class PatchedForm<T>
     ...
     */
    public PatchedForm(final String rootName, final Class<T> clazz, final Map<String, String> data, final Map<String, List<ValidationError>> errors, final Option<T> value) {

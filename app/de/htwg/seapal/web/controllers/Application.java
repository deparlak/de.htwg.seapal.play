...
public class Application
    ...
    public static Result javascriptRoutes() {
        ...
        return ok(Routes.javascriptRouter("jsRoutes",
                // Routes
                // Application
                de.htwg.seapal.web.controllers.routes.javascript.Application.boat_info(), de.htwg.seapal.web.controllers.routes.javascript.Application.trip_list(), de.htwg.seapal.web.controllers.routes.javascript.Application.trip_edit(), de.htwg.seapal.web.controllers.routes.javascript.Application.waypoint_show(), de.htwg.seapal.web.controllers.routes.javascript.Application.seamap(), de.htwg.seapal.web.controllers.routes.javascript.Application.race_list(),
                ...
                // API
                de.htwg.seapal.web.controllers.routes.javascript.BoatAPI.boatAsJson(), de.htwg.seapal.web.controllers.routes.javascript.BoatAPI.boatsAsJson(), de.htwg.seapal.web.controllers.routes.javascript.BoatAPI.deleteBoat(), de.htwg.seapal.web.controllers.routes.javascript.BoatAPI.addBoat(), de.htwg.seapal.web.controllers.routes.javascript.TripAPI.tripsAsJson(), de.htwg.seapal.web.controllers.routes.javascript.TripAPI.tripAsJson(), de.htwg.seapal.web.controllers.routes.javascript.TripAPI.allTripsAsJson(), de.htwg.seapal.web.controllers.routes.javascript.TripAPI.addTrip(), de.htwg.seapal.web.controllers.routes.javascript.WaypointAPI.addWaypoint(), de.htwg.seapal.web.controllers.routes.javascript.WaypointAPI.waypointAsJson(), de.htwg.seapal.web.controllers.routes.javascript.WaypointAPI.waypointsAsJson(), de.htwg.seapal.web.controllers.routes.javascript.BoatPositionAPI.current(), de.htwg.seapal.web.controllers.routes.javascript.RaceAPI.allRacesAsJson(), de.htwg.seapal.web.controllers.routes.javascript.RaceAPI.deleteRace(), de.htwg.seapal.web.controllers.routes.javascript.RaceAPI.addRace()));
    }
}

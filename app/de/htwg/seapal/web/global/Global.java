package de.htwg.seapal.web.global;

import java.lang.reflect.Method;

import com.google.inject.Guice;

import de.htwg.seapal.web.global.module.DefaultModule;
import play.Logger;
...
public class Global extends GlobalSettings {
    ...
    public <A> A getControllerInstance(Class<A> controllerClass) throws Exception {
        ...
        return Guice.createInjector(new DefaultModule()).getInstance(controllerClass);
    }
